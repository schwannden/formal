            ...
            <Grid>
              <Row>
                <Col xs={12}>
                    ...
                    <Row>
                      <Col xs={6} collapseLeft collapseRight>
                        <div className='fg-darkgray50'>
                          <small>by <Link to={path_helper('/blog/post')}>{this.props.author}</Link> / {this.props.date}</small>
                        </div>
                      </Col>
                  ...
                  <p>
                    <Link to={path_helper('/blog/post')}>Read More</Link>
                  </p>
                </Col>
              </Row>
            </Grid>
                          ...
                          <Row>
                            <Col xs={12} className='text-center'>
                              <div className='text-left'>
                                ...
                                <div style={{marginBottom: 12.5}}>
                                  <Link to={path_helper('/blog/post')}><LoremIpsum className='text-capitalize' query='3w'/></Link>
